...
const Admin = () => {
    ...
    const handleDeleteUser = async (userId) => {
        try {
            ...
            await axios.delete(`http://localhost:8080/userDetails/${userId}`);
    ...
    const handleEditClick = (userId) => {
        ...
        // Set the initial editedUserData based on the existing data
    ...
    const handleSaveEdit = async (userId) => {
        try {
            // Send a PUT request to your API to update the user data
            await axios.put(
                `http://localhost:8080/userDetails/${userId}`,
                editedUserData
            );
            // Update the local state with the edited data
            setallusers((prevUsers) =>
                prevUsers.map((user) =>
                    user.id === userId ? editedUserData : user
                )
            );
            // Exit edit mode
            setEditingRow(null);
                                ...
                                <tr key={contact.id}>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            onClick={() =>
                                                handleInterestToggle(contact.id)
                                            }>
                                            {contact.interested
                                                ? "Interested"
                                                : "Not Interested"}
